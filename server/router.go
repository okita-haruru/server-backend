...
func NewRouter(server *Server, conf config.Config, socketserver *socketio.Server) *gin.Engine {
	...
	r.GET("/ranking/warden", server.controller.HandleGetPlayerKillStatsSortByWarden)
	r.GET("/ranking/ender_dragon", server.controller.HandleGetPlayerKillStatsSortByEnderDragon)
	r.GET("/ranking/wither", server.controller.HandleGetPlayerKillStatsSortByWither)
	r.GET("/ranking/piglin", server.controller.HandleGetPlayerKillStatsSortByPiglin)
	r.GET("/ranking/phantom", server.controller.HandleGetPlayerKillStatsSortByPhantom)
